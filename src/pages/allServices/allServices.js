        ...
        <>
            <div className="all-services">
                <div className="container  services-detail pt-5">
                    ...
                    <div class="modal-header-abc  p-4 0 rounded-t-md"  id="div-22">
                    ...
                    <div class="modal-header-abc  p-4 0 rounded-t-md"  id="div-23">
                    ...
                    <div class="modal-header-abc  p-4 0 rounded-t-md"  id="div-26">
                    ...
                    <div class="modal-header-abc  p-4 0 rounded-t-md"  id="div-27">
                    ...
                    <div class="modal-header-abc  p-4 0 rounded-t-md"  id="div-28">
                        <i class="fa fa-plug oic-icon" aria-hidden="true"></i>
                        <h3 className="text-base mt-5" style={{ fontWeight: '600' }}>Division 28 — Electronic Safety and Security</h3>
